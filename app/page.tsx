...
const SECTOR_MAP: Record<string, string[]> = {
  "Auto": ["ASHOKLEY","ATHERENERG","BAJAJ-AUTO","EICHERMOT","FORCEMOT","HEROMOTOCO","HYUNDAI","M&M","MARUTI","TMPV","TVSMOTOR"],
  "Auto Ancillary": ["BHARATFORG","BOSCHLTD","MOTHERSON","SONACOMS","UNOMINDA"],
  "Aviation": ["INDIGO"],
  "BFSI": ["360ONE","ABCAPITAL","ANGELONE","AUBANK","AXISBANK","BAJAJFINSV","BAJFINANCE","BANDHANBNK","BANKBARODA","BANKINDIA","CANBK","CHOLAFIN","FEDERALBNK","HDFCAMC","HDFCBANK","HDFCLIFE","ICICIBANK","ICICIGI","ICICIPRULI","IDFCFIRSTB","INDIANB","INDUSINDBK","IREDA","IRFC","KOTAKBANK","LICHSGFIN","LICI","LTF","MAHABANK","MANAPPURAM","MFSL","MOTILALOFS","MUTHOOTFIN","NAM-INDIA","PFC","PNB","PNBHOUSING","RBLBANK","RECLTD","SBICARD","SBILIFE","SBIN","SHRIRAMFIN","UNIONBANK","YESBANK"],
  "Capital Goods": ["ABB","AMBER","BEL","BHEL","BLUESTARCO","CGPOWER","CROMPTON","CUMMINSIND","GVT&D","HAL","HAVELLS","KAYNES","KEI","LT","POLYCAB","POWERINDIA","PREMIERENE","SIEMENS","SUZLON","TIINDIA","VOLTAS","WAAREEENER"],
  "Cement": ["AMBUJACEM","SHREECEM","ULTRACEMCO"],
  "Chemicals": ["ASIANPAINT","ASTRAL","PIDILITIND","PIIND","SOLARINDS","SRF","SUPREMEIND","UPL"],
  "Consumer Discretionary": ["DIXON","PAGEIND","PGEL","TITAN"],
  "Consumer Internet": ["ETERNAL","NAUKRI","NYKAA","PAYTM","POLICYBZR","SWIGGY"],
  "Defence": ["BDL","COCHINSHIP","MAZDOCK"],
  "Diversified": ["ADANIENT","BAJAJHLDNG","GRASIM"],
  "FMCG": ["BRITANNIA","COLPAL","DABUR","GODFRYPHLP","GODREJCP","HINDUNILVR","ITC","MARICO","NESTLEIND","PATANJALI","RADICO","TATACONSUM","UNITDSPR","VBL"],
  "Financial Services": ["BSE","CAMS","CDSL","IEX","JIOFIN","KFINTECH","MCX"],
  "Healthcare": ["APOLLOHOSP","FORTIS","MAXHEALTH"],
  "Hospitality": ["INDHOTEL"],
  "IT": ["COFORGE","HCLTECH","INFY","KPITTECH","MPHASIS","OFSS","PERSISTENT","SAGILITY","TATAELXSI","TCS","TECHM","WIPRO"],
  "Infrastructure": ["ADANIPORTS","GMRAIRPORT","NBCC","RVNL"],
  "Logistics": ["CONCOR","DELHIVERY"],
  "Metals & Mining": ["APLAPOLLO","COALINDIA","HINDALCO","HINDZINC","JINDALSTEL","JSWSTEEL","NATIONALUM","NMDC","SAIL","TATASTEEL","VEDL"],
  "Oil & Gas": ["BPCL","GAIL","HINDPETRO","IOC","OIL","ONGC","PETRONET","RELIANCE"],
  "Pharma": ["ALKEM","AUROPHARMA","BIOCON","CIPLA","DIVISLAB","DRREDDY","GLENMARK","LAURUSLABS","LUPIN","MANKIND","SUNPHARMA","TORNTPHARM","ZYDUSLIFE"],
  "Real Estate": ["DLF","GODREJPROP","LODHA","OBEROIRLTY","PHOENIXLTD","PRESTIGE"],
  "Retail": ["DMART","JUBLFOOD","KALYANKJIL","TRENT","VMM"],
  "Telecom": ["BHARTIARTL","IDEA","INDUSTOWER"],
  "Utilities": ["ADANIENSOL","ADANIGREEN","ADANIPOWER","INOXWIND","JSWENERGY","NHPC","NTPC","POWERGRID","TATAPOWER"],
}
            ...
            <div className="col-span-2 bg-blue-950/20 border border-blue-800/30 rounded-xl p-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="text-center">
                  ...
                  <p className={`text-xs font-bold ${(data.fut_signal.fut_oi_chg_pct||0)>=0?'text-emerald-400':'text-red-400'}`}>
                    {(data.fut_signal.fut_oi_chg_pct||0)>0?'+':''}{Number(data.fut_signal.fut_oi_chg_pct||0).toFixed(2)}%
                    {data.fut_signal.fut_oi_close !== null && data.fut_signal.fut_oi_close !== undefined && (
                      <span className="text-[9px] text-gray-500 font-normal ml-1">({fmtOI(data.fut_signal.fut_oi_close)})</span>
                    )}
                  </p>
                  {data.fut_signal.fut_oi_chg_pct_next !== null && data.fut_signal.fut_oi_chg_pct_next !== undefined && (
                    <p className="text-[9px] mt-0.5 leading-tight" title="Next-month FUT OI change. If also strongly positive, the current-month figure is likely genuine positioning, not just expiry-week rollover.">
                      <span className={data.fut_signal.fut_oi_chg_pct_next>=0?'text-emerald-500/70':'text-red-500/70'}>
                        ...
                        {data.fut_signal.fut_oi_close_next !== null && data.fut_signal.fut_oi_close_next !== undefined && (
                          <span className="text-gray-600"> ({fmtOI(data.fut_signal.fut_oi_close_next)})</span>
                        )}
                      </span>
