...
const STOCKS = [
  ...
  'CIPLA','COALINDIA','DLF','DIXON','DRREDDY',
  'EICHERMOT','GAIL','GRASIM','HAL','HAVELLS',
  'HCLTECH','HDFCBANK','HDFCLIFE','HEROMOTOCO','HINDALCO',
  'HINDUNILVR','ICICIBANK','INDIGO','INDUSINDBK','INFY',
  'ITC','JIOFIN','JSWSTEEL','KOTAKBANK','LT',
  'M&M','MARUTI','NESTLEIND','NTPC','NYKAA',
  'ONGC','PAYTM','PFC','PERSISTENT','POWERGRID',
  'RECLTD','RELIANCE','SAIL','SBILIFE','SBIN',
  'SHRIRAMFIN','SUNPHARMA','TATACONSUM','TATAPOWER','TATASTEEL',
