...
export default function OISpikes() {
  ...
  const fetchSpikes = useCallback(async () => {
    setLoading(true)
    try {
      const res = await fetch(`http://localhost:8000/oi-spikes?threshold=${thresholdRef.current}`)
      ...
      <nav className="sticky top-0 z-50 border-b border-gray-800/50 bg-[#07070e]/90 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="/spikes" className="text-sm font-semibold text-white border-b border-emerald-500 pb-0.5">OI Spikes</a>
